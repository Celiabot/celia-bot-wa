...
owner = `${control.+6283135535548}`
banChats = false;
LolApi = "Celia"
const lolkey = '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'  //apikey nya
target = `${control.+6283135535548}@s.whatsapp.net`//Ganti jadi nomor lu
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
// Kalo Make Kasi WM Made By Celia!!          
        var ikan = ['🐳','🦈','🐬','🐋','🐟','🐠','🦐','🦑','🦀','🐡','🐙']
        var hewan = ['🐔','🦃','🦆','🐐','🐏','🐖','🐑','🐎']
        var burung = ['🦋','🕷','🐝','🐉','🦆','🦅','🕊','🐧','🐦','🦇']        
        var petnya = ['😾','🐺','🦊','🐶','🐰']
